        ...
        <section>
          ...
          <div className="rainbow-chart-embed">
            ...
            <div className="rainbow-legend">
              ...
              <div className="legend-item"><span className="dot red"></span>Vender</div>
              ...
              <div className="legend-item current"><span className="dot purple"></span>Liquidación ← Hoy</div>
            </div>

            <div className="rainbow-footer">
              <strong>Lectura actual:</strong> Bitcoin (~$65K) está en la zona violeta — &quot;Liquidación total&quot;.
